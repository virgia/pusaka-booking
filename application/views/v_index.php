<section>
    ...
    <ol type="a">
        ...
        <p align="justify">Model adalah kelas yang merepresentasikan atau memodelkan 
            ...
            database lainnya. Semua intruksi atau fungsi yang berhubung dengan pengolahan database
            di letakkan di dalam model. Sebagai contoh, jika ingin membuat aplikasi
            ...
            <p align="justify">Sebagai catatan, Semua model harus disimpan di
                ...
                pada menangani bagian controller dan modelnya. Jadi pembagian tugas pun
